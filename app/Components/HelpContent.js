...
export default function HelpContent() {
    return (
      <div className="flex justify-between items-center px-6 py-8">
        ...
        <div className="w-1/2">
          <Image
            src="/con.jpg" // Use a placeholder image or the actual image path here
            alt="Pocket Empty"
            width={598} 
            height={479} 
        ...
        <div className="w-1/2 flex flex-col space-y-6">
          <h1 className="text-[43px]">
            Helping Printer Maintenance <br />
            <span className="text-pink-600">Can Burn A Hole In Your Pocket!!</span>
          </h1>
  
          <h2 className="text-[40px] text-pink-600 ">Use</h2>
          ...
          <button className="bg-pink-600 text-white px-6 py-3 rounded-[30px] w-max">
            Get Assistance
          </button>
        </div>

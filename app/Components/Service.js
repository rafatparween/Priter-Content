...
// Icon component to dynamically choose the icon based on the name
const Icon = ({ name, className }) => {
  ...
  const IconComponent = icons[name] || FaTools; // Default to FaTools if the name is not found
...
const Service = () => {
  return (
    <section
      className="relative h-[1100px] overflow-hidden text-white py-20"
      style={{
        background:
          'linear-gradient(to top, rgba(255, 255, 255, 0), rgba(212, 167, 213, 0.4) 17%, rgb(207, 81, 165) 82%)',
      }}
    >
      {/* Left Triangular Patterns */}
      <div className="absolute left-0 top-0 h-full w-1/2">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="text-lg text-white mb-12">
          Explore our top-rated services that guarantee fast and efficient printer maintenance, repairs, and more!
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm mb-6">
              We offer professional printer repair services for all major printer brands. Whether it’s a hardware issue or
              software glitch, we fix it quickly to get you back to work.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Fast diagnostics and repair</li>
              <li>Support for all printer models</li>
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-4">Printer Maintenance</h3>
            <p className="text-sm mb-6">
              Regular printer maintenance can increase the lifespan of your printer and keep it running like new. Our experts
              offer full-service checkups and cleaning for your device.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Regular maintenance schedules</li>
              <li>Thorough internal and external cleaning</li>
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-4">Support & Consultation</h3>
            <p className="text-sm mb-6">
              Need advice or troubleshooting support? Our expert technicians offer phone and online consultations to help you
              resolve any printer issues you encounter.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Remote troubleshooting support</li>
              <li>Expert consultation for your printer setup</li>
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-4">Printer Installation</h3>
            <p className="text-sm mb-6">
              Our team offers professional printer installation for businesses and home offices. We ensure your printer is set
              up and connected properly to your devices.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Easy, quick printer setup</li>
              <li>Network and Wi-Fi configuration</li>
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold mb-4">Printer Protection Plan</h3>
            <p className="text-sm mb-6">
              Our protection plans ensure your printer is always covered, with regular checkups and quick repairs to avoid any
              downtime.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Annual service checkups</li>
          ...
          <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300">
            <div className="text-4xl mb-4 text-blue-500">
              <Icon name="FaMobileAlt" />
            </div>
            <h3 className="text-xl font-semibold mb-4">Mobile Printer Solutions</h3>
            <p className="text-sm mb-6">
              Our mobile printing services allow you to print from anywhere with ease, whether you’re in the office, at home, or
              on the go.
            </p>
            <ul className="list-disc text-left mb-4">
              <li>Mobile app integration</li>
        ...
        {/* Call to Action */}
        <div className="mt-12">
          <a href="#contact" className="bg-pink-600 hover:bg-pink-700 text-white px-8 py-3 rounded-full text-lg font-semibold">
            Get In Touch
          </a>
        </div>
      </div>
